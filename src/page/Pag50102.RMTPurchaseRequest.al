page 50102 "RMT Purchase Request"
{
  ...
  SourceTableView = WHERE("Document Type"=FILTER(Quote), "RMT Purchase Request"=filter(true));
  ...
  layout
  {
    area(content)
    {
      group(General)
      {
        ...
        field("No.";"No.")
        {
          ...
          trigger OnAssistEdit()begin
            if AssistEditRequest(xRec)then CurrPage.Update();
          end;
        }
        ...
        field("Buy-from Vendor Name";"Buy-from Vendor Name")
        {
          ...
          trigger OnLookup(var Text: Text): Boolean begin
            if LookupBuyfromVendorName()then CurrPage.Update();
          end;
        }
        group("Buy-from")
        {
      ...
      part(PurchLines;"RMT Purchase Request Subform")
      {
        ApplicationArea = Suite;
        Editable = "Buy-from Vendor No." <> '';
      ...
      group("Shipping and Payment")
      {
        ...
        group(Control51)
        {
          ...
          field(PayToOptions;PayToOptions)
          {
            ...
            trigger OnValidate()begin
              if PayToOptions = PayToOptions::"Default (Vendor)" then Validate("Pay-to Vendor No.", "Buy-from Vendor No.");
            end;
          }
          group(Control67)
          {
            ...
            field("Pay-to Name";"Pay-to Name")
            {
              ...
              trigger OnValidate()begin
                if GetFilter("Pay-to Vendor No.") = xRec."Pay-to Vendor No." then if "Pay-to Vendor No." <> xRec."Pay-to Vendor No." then SetRange("Pay-to Vendor No.");
                CurrPage.Update();
              end;
            }
      ...
      group(Action92)
      {
        ...
        action(PrintQoute)
        {
          ...
          begin
            ...
            report.RunModal(Report::"RMT PurchaseQuotes", true, true, PurchaseHeader);
          end;
        }
        action(Print)
        {
